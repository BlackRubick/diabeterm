  ...
  <div class="max-w-3xl mx-auto space-y-5">
    ...
    <div class="flex items-center gap-3">
      ...
      <div>
        ...
        <p class="text-xs" style="color: var(--text-3)">Resultado de tu análisis podológico</p>
      </div>
    </div>
        ...
        <div class="p-5 grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div class="space-y-1">
            <div class="flex items-center gap-1.5">
              <UIcon name="i-heroicons-calendar-days" class="text-xs" style="color: var(--text-3)" />
              <p class="text-xs" style="color: var(--text-3)">Fecha</p>
            </div>
            <p class="text-sm font-semibold" style="color: var(--text-1)">{{ formatDate(evaluation.fecha) }}</p>
          </div>
          <div class="space-y-1">
            <div class="flex items-center gap-1.5">
              <UIcon name="i-heroicons-user-circle" class="text-xs" style="color: var(--text-3)" />
              <p class="text-xs" style="color: var(--text-3)">Doctor</p>
            </div>
            <p class="text-sm font-semibold" style="color: var(--text-1)">{{ evaluation.doctor?.nombre }}</p>
          </div>
          <div class="space-y-1">
            <div class="flex items-center gap-1.5">
